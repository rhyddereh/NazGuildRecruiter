...
NazGuildRecruiter = AceLibrary("AceAddon-2.0"):new("AceConsole-2.0", "AceEvent-2.0", "AceDB-2.0", "AceComm-2.0")
NazGuildRecruiter:RegisterChatCommand(L["Slash-Commands"], options)
NazGuildRecruiter:RegisterDB("NazGuildRecruiterDB", "NazGuildRecruiterDBPC")
NazGuildRecruiter:RegisterDefaults("profile", {
...
--Northrend
zones[Z["Borean Tundra"]] = {
    low = 68,
    high = 72,
}

zones[Z["Howling Fjord"]] = {
    low = 68,
    high = 72,
}

zones[Z["Dragonblight"]] = {
    low = 71,
    high = 74,
}

zones[Z["Grizzly Hills"]] = {
    low = 73,
    high = 75,
}
...
zones[Z["Sholazar Basin"]] = {
    low = 76,
    high = 78,
}

zones[Z["Crystalsong Forest"]] = {
    low = 77,
    high = 80,
}
